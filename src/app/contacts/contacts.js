      ...
      function ($stateProvider, $urlRouterProvider) {
        $stateProvider
          ...
          .state('contacts', {
            ...
            abstract: true,//由子状态填充,如果没有这个属性,或者属性为false,那么子状态不会被加载!
            url: '/contacts',
          ...
          .state('contacts.list', {
            ...
            url: '',//默认视图,由于是子状态,url自动追加/contacts
          ...
          .state('contacts.detail.item', {
            ...
            views: {
              ...
              'hint@': {
                template: ' <p> This is contacts.detail.item overriding the "hint" ui-view </p>'
              }
            }
          })
